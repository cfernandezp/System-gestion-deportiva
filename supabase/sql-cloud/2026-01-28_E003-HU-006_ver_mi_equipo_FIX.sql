-- ============================================
-- E003-HU-006: Ver Mi Equipo - VERSION CORREGIDA
-- Fecha: 2026-01-28
-- Descripcion: Script unificado que maneja correctamente el ENUM
-- SOLUCION: Usar schema explicito y DO block para manejo de errores
-- ============================================
--
-- INSTRUCCIONES:
-- 1. Ejecutar este script COMPLETO en SQL Editor de Supabase Cloud
-- 2. Este script reemplaza los dos scripts anteriores (PASO1_enum y ver_mi_equipo)
-- 3. Maneja el caso donde el ENUM ya existe sin fallar
--
-- ============================================

-- ============================================
-- PARTE 0: CREAR ENUM (con manejo de "ya existe")
-- ============================================

DO $$
BEGIN
    -- Intentar crear el tipo ENUM
    -- Si ya existe, el bloque EXCEPTION lo maneja silenciosamente
    CREATE TYPE public.color_equipo AS ENUM (
        'naranja',
        'verde',
        'azul',
        'rojo',
    ...
    RAISE NOTICE 'ENUM color_equipo creado exitosamente';
EXCEPTION
    WHEN duplicate_object THEN
        RAISE NOTICE 'ENUM color_equipo ya existe, continuando...';
END $$;

-- ============================================
-- PARTE 1: TABLA ASIGNACIONES_EQUIPOS
-- ============================================
-- Usar public.color_equipo explicitamente para evitar problemas de schema
...
CREATE TABLE IF NOT EXISTS asignaciones_equipos (
    ...
    color_equipo public.color_equipo NOT NULL,
...
EXCEPTION
    WHEN duplicate_object THEN
        RAISE NOTICE 'Tabla ya esta en supabase_realtime, continuando...';
END $$;
