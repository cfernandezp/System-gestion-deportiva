...
**Restriccion de plan**: Stats avanzadas (promedios, racha, mejor fecha, comparativa con grupo) disponibles desde Plan 5+. Plan Gratis ve metricas basicas (goles totales, fechas asistidas).
...
### CA-004: Promedio de goles (Plan 5+)
- **Dado** que veo mis estadisticas
...
### RN-009: Restriccion por Plan
**Contexto**: Feature flag de stats avanzadas.
**Restriccion**:
  - Plan Gratis: Metricas basicas (goles totales, fechas asistidas, partidos jugados)
  - Plan 5+: Todo lo anterior + posicion en rankings, promedios, comparativa con grupo, historial por fecha, mejor fecha, racha
**Validacion**: Verificar plan del usuario via limites_plan.stats_avanzadas.
**Caso especial**: Invitados NO tienen acceso a estadisticas (solo jugadores).
...
- Depende de E006-HU-001 (ranking goleadores) y E006-HU-002 (ranking puntos) para posiciones
